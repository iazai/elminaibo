            ...
            <div class="maincontentinner">
				...
				<div class="span8">
					<div class="widgetbox personal-information">
						...
						<form id="addForm" name="addForm" class="stdform" method="post" action="<?=base_url()?>index.php/wallet/doAdd" />
							<div id="wiz1step1" class="formwiz">
								<h4 class="widgettitle">&nbsp; Deposit Money </h4>
